"""Legacy canonical renderer v8 focused on semantic preservation.

The historical Word document remains immutable. Its representable semantics are
converted to Markdown, including inherited Word emphasis, then the ordinary GPT
Exporter Markdown -> DOCX renderer produces the normalized document.
"""
...
CANONICAL_LEGACY_DOCX_VERSION = "legacy-canonical-docx-v8"
...
def _with_v8_semantic_renderer(function, *args, **kwargs):
...
def build_legacy_markdown(
    ...
    *,
    ...
    return _with_v8_semantic_renderer(
