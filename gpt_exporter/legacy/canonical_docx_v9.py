"""Legacy canonical renderer v9 focused on semantic preservation.

The historical Word document remains immutable. Its representable semantics are
converted to Markdown, including direct and inherited character-style emphasis,
then the ordinary GPT Exporter Markdown -> DOCX renderer produces the normalized
document. Paragraph-style emphasis is represented by block semantics such as
headings rather than duplicated as inline Markdown.
"""
...
CANONICAL_LEGACY_DOCX_VERSION = "legacy-canonical-docx-v9"
...
def _with_v9_semantic_renderer(function, *args, **kwargs):
...
def build_legacy_markdown(
    ...
    *,
    ...
    return _with_v9_semantic_renderer(
